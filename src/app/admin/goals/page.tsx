...
export default function AdminGoalsPage() {
  ...
  const [appSettings, setAppSettings] = useState({ app_name: "Mentorhipers", app_logo: "" });
    ...
    <div className="min-h-screen bg-[#F5F6FA] flex overflow-x-hidden font-sans">
      ...
      >
        ...
        <nav className="flex flex-col flex-1">
           ...
           <AdminNavItem label="Goals Control" icon={<Target />} active href="/admin/goals" collapsed={!isSidebarOpen} />
               ...
               <div className="space-y-3 max-h-[70vh] overflow-y-scroll no-scrollbar pr-2 pb-10">
                 {clients.map(client => (
                   <button
                     ...
                     className={`w-full p-4 rounded-[14px] flex items-center gap-4 transition-all border ${
                                        ...
                                        <div className="flex flex-col md:flex-row justify-between gap-10">
                                           <div className="space-y-5 flex-1">
                                              <div className="flex items-center gap-3">
                                                  <span className={`px-3 py-1.5 rounded-lg text-[10px] font-black uppercase tracking-widest ${
                                                    task.category === 'Vision' ? 'bg-blue-50 text-blue-600' :
                                           ...
                                           <div className="flex flex-col gap-3 min-w-[220px]">
                                              ...
                                              <select 
                                                ...
                                                className={`h-12 w-full rounded-[10px] px-4 font-black text-[11px] uppercase tracking-[1px] border-2 focus:outline-none transition-all ${
                                                  task.status === 'Completed' ? 'border-emerald-100 bg-emerald-50 text-emerald-600' :
