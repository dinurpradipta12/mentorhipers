...
const CategoryItem = ({ label, icon, count, active, onClick }: any) => (
  <button
    onClick={onClick}
    className={`w-full flex items-center justify-between px-6 py-3.5 rounded-xl transition-all ${active ? "bg-[#4880FF] text-white" : "text-[#202224] opacity-60 hover:bg-slate-50 hover:opacity-100"
      }`}
  >
