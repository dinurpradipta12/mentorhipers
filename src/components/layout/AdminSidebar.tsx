      ...
      <nav className="flex flex-col flex-1">
         ...
         <div className="mt-auto mb-10 space-y-2">
             <div className={`px-4 mb-4 ${!isSidebarOpen ? 'px-2' : ''}`}>
               <Link href="/ruang-sosmed" className={`flex items-center gap-3 p-4 rounded-2xl bg-gradient-to-br from-blue-600 to-indigo-700 text-white shadow-lg shadow-blue-500/20 hover:scale-[1.02] transition-all overflow-hidden relative group ${!isSidebarOpen ? 'justify-center px-0' : ''}`}>
                  ...
                  {isSidebarOpen && <span className="text-[12px] font-black uppercase tracking-widest relative z-10">Ruang Sosmed</span>}
               </Link>
            </div>
            <AdminNavItem 
              label="App Settings" 
